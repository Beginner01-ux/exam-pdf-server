...
# ===== CONFIGURATION =====
SHEET_URL = "https://docs.google.com/spreadsheets/d/1xrfzqniGYl99m9g9Jf97hmDQUa_a54KexIiur2-frDU/edit"
SHEET_NAME = "exam_serial_numbers"

# ===== PAGE SETUP =====
st.set_page_config(page_title="Exam PDF Access", layout="centered")
st.title("Student Databse Portal")
st.title("by: MANISH LOHANA")
